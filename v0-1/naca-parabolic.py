...
#Adjusted position
#this idea is wrong; the only thing that is constant with the
#rotation is not the whole nodes on the surface; but the leading edge!
#meaning; I need to calculate the displacement with respect to leading
